  ...
  return (
    <Container className="my-auto">
      ...
      <p className="fs-5 mx-auto">
        ...
        No se requiere autenticación para acceder a esta API, y
      ...
      <h2><b>¿Por qué?</b></h2>
      <p className="fs-5 mx-auto">
        Porque quería construir un proyecto de código abierto y nunca había creado una API, después de investigar por un tiempo no encontré ninguna en español de esta temática
        y surgió la idea de preguntAPI.
      </p>
      <br />
      <h2><b>Como contribuir en el proyecto</b></h2>
      <p className="fs-5 mx-auto">
        Si usas la API y encuentras algún error en las preguntas puedes avisarme en el siguiente correo: info@preguntapi.dev <br />
        También puedes contribuir en <a href="https://github.com/gmorte/preguntapi" target="_blank">GitHub</a>
      </p>
      ...
      <br />
      <p className="fs-5 mx-auto">
        El único recurso disponible es "questions", se utiliza para obtener todas las preguntas. "questions" puede recibir dos parámetros: "category" y "limit". <br />
        <br />
        Si solo se especifica "category" la API devolverá todas las preguntas de esa misma categoría. <br />
        <br />
